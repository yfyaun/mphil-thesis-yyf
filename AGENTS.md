...
“研究事实”“论文大纲”和“正式 LaTeX 正文”，避免把尚未稳定的实验观察或
算法设想提前写成最终结论。
...
1. `docs/work_brief.md`
   - 这是当前研究工作的事实源。
   - 用于记录论文背景、研究问题、候选贡献、系统模型、算法框架、实验计划、
     当前证据和尚未稳定的部分。
...
- 如果需要在 LaTeX 正文中临时备注，可使用英文 TODO 标记，避免混入中文段落。

## 论文写作质量要求

- 不得虚构实验结果、baseline、数值、引用或算法细节。
- 如果证据不足，应明确标记为 `TODO[needs-evidence]: ...`。
- 如果方法细节尚未稳定，应明确标记为 `TODO[unstable-method]: ...`。
