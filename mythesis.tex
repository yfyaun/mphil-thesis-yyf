...
\hkustsetup {
  ...
  info = {
    ...
    author        = {Yifeng YUAN},
    Hub           = {Information Hub},
    Thrust        = {Internet of Things Thrust},
    program       = {Internet of Things Thrust},
    major         = {Internet of Things},
    supervisor    = {Prof Shijian GAO},
    %% Co-supervisor; leave it {} if not available
    co-supervisor = {Prof Jia YAN},
    submit-month  = {August 2026},    % <month year>
    submit-date   = {13 August 2026}, % <date month year>
    defend-date   = {20 July 2025},   % <date month year>
    depthead      = {Prof Hin Kwok TSANG, Head of Thrust},
...
\input{chapters/Ch_System_Model.tex}
\input{chapters/Ch_Methodology.tex}
